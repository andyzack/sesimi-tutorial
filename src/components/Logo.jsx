...
export const Logo = ({colors = {logoPart1: `fill-tataplay-white`, logoPart2: `fill-tataplay-pink`}, className = ``, style = {}}) => {
  return (
    <>
      <svg className={`${className}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171.67 20.16">
        <polygon
          className={`${colors.logoPart1}`}
